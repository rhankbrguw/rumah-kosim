...
<form method="POST" action="?/signup" use:enhance transition:fade>
	...
	{/if}
	<div class="mb-4">
		<label for="signup-username" class="mb-1 block text-sm font-medium text-text-main"
	...
	<div class="mb-4">
		<label for="signup-email" class="mb-1 block text-sm font-medium text-text-main"
	...
	<div class="mb-4">
		<label for="signup-password" class="mb-1 block text-sm font-medium text-text-main"
	...
	<div class="mb-6">
		<label for="signup-confirmPassword" class="mb-1 block text-sm font-medium text-text-main"
