...
import { CART_STRINGS } from './cartStrings';
...
import { META_STRINGS } from './metaStrings';
...
export const STRINGS = {
	...
	NAVIGATION: {
		...
		BRAND: 'RumahKosimBook'
	},
	ADMIN: ADMIN_STRINGS,
	HERO: {
		BADGE: 'Curated Bookstore & Literary Sanctuary',
		...
		SUBTITLE:
			'Discover your favorite stories, rare editions, and timeless treasures at RumahKosimBook.',
		CTA_BUTTON: 'Explore Books',
		SECONDARY_CTA: 'About Us',
		STAT_AUTH: '100% Authentic',
		STAT_TITLES: 'Curated Catalog',
		STAT_SHIPPING: 'Nationwide Delivery',
