						...
						<div class="flex items-center justify-center gap-1.5">
							...
							>
								...
								<div class="relative inline-flex items-center">
									<select
										name="status"
										class="select-clean cursor-pointer appearance-none rounded-lg border border-secondary/30 bg-surface py-1 pl-2.5 pr-7 text-xs font-medium text-text-main shadow-sm transition-colors hover:border-primary focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary disabled:cursor-not-allowed disabled:opacity-50"
