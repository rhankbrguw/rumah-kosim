...
<div class="relative h-28 bg-gradient-to-r from-primary to-primary-hover sm:h-36">
	<div class="absolute -bottom-10 left-6 sm:-bottom-12 sm:left-8">
		<div class="relative h-20 w-20 sm:h-24 sm:w-24">
			<div
				class="flex h-full w-full items-center justify-center overflow-hidden rounded-full border-4 border-surface bg-surface-alt shadow-lg"
			>
			...
			<label
				for="avatar_upload"
				class="absolute bottom-0 right-0 cursor-pointer rounded-full bg-primary p-1.5 text-secondary shadow-md transition-transform hover:scale-110 hover:bg-primary-hover"
				aria-label={STRINGS.PROFILE.AVATAR.CHANGE}
			>
